///////////////////////////--     NASTAVENÍ PROMĚNNÝCH     --//////////////////////////////////
    ...
    int setHours1 = 21, setMinutes1 = 00, setSeconds1 = 10; // nastavení hodin, minut and vteřin pro zapnutí relé = jede nahoru
    
    
    long RelayTime1 = 3000; //délka zapnutí 1. relé v ms. datatyp int udrží maximálně hodnotu 32767.
    long RelayTime2= 1100; //délka zapnutí 2. relé v ms. datatyp int udrží maximálně hodnotu 32767.
...
///////////////////////////--    ZAPNUTÍ     --//////////////////////////////////
    ...
    void setup() {
      ...
      digitalWrite(RelayA, HIGH);  //vypnutý stav / relé připojeno na NC / COM
...
void displayTime(){
    ...
    switch(dayOfWeek){
      ...
      if (hour == setHours && minute == setMinutes && second == setSeconds)
      {
        ...
        digitalWrite(RelayA, LOW);  //turns on relay
        ...
        digitalWrite(RelayA, HIGH); // turn off the relay
